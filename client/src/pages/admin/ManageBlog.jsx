  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-display font-bold mb-2">Blog Posts</h1>
          <p className="text-[var(--text-secondary)]">Manage your articles and news</p>
        </div>
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-2xl p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-[var(--text-secondary)] max-w-md">
          The blog management module is currently under development. Check back later!
        </p>
      </div>
    </div>
  );
